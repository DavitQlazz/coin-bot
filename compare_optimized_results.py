#!/usr/bin/env python3
"""
Compare Optimized Stochastic RSI Results Across Multiple Pairs
"""
...
def main():
    ...
    # Print comparison
    print("="*80)
    print("OPTIMIZED STOCHASTIC RSI - MULTI-PAIR COMPARISON")
    print("="*80)
    ...
    if profitable_pairs:
        ...
        print(f"• Consider portfolio allocation: 40% {top_pairs[0]['pair']}, 30% {top_pairs[1]['pair']}, 30% other pairs")
    else:
        print("• Strategy needs parameter optimization")
        print("• Consider adjusting Stoch RSI levels or timeframe")

    print(f"• Monitor for overfitting - validate on out-of-sample data")
    print(f"• Implement proper position sizing and risk management")
