#!/usr/bin/env python3
"""
Optimized Multi-Pair Stochastic RSI Strategy Backtest
Target: 80+ trades with 67%+ win rate
Using optimized parameters for higher trade frequency
"""
...
def calculate_stoch_rsi_signals(df, rsi_period=14, stoch_period=14, k_period=3, d_period=3,
    ...
    """Calculate Stochastic RSI signals with optimized parameters"""
    try:
...
def run_optimized_multi_pair_stoch_rsi_backtest(pairs, timeframe='1h', period_days=720,
                                               rsi_period=14, stoch_period=14, k_period=3, d_period=3,
                                               overbought=75, oversold=25,
                                               risk_per_trade=0.015, stop_loss_pct=0.02, take_profit_pct=0.05):
    """Run optimized multi-pair Stochastic RSI backtest"""

    print("🎯 Optimized Multi-Pair Stochastic RSI Strategy")
    print("=" * 80)
    print("🚀 Optimized Multi-Pair Stochastic RSI Strategy")
    ...
    print("\n" + "=" * 80)
    print("📊 OPTIMIZED MULTI-PAIR STOCH RSI RESULTS")
    print("=" * 80)
    ...
    with open('optimized_multi_pair_stoch_rsi_results.json', 'w') as f:
        json.dump(results, f, indent=2, default=str)

    print("\n💾 Results saved to optimized_multi_pair_stoch_rsi_results.json")
...
if __name__ == "__main__":
    ...
    # Run the optimized backtest with 1h timeframe and adjusted parameters
    results = run_optimized_multi_pair_stoch_rsi_backtest(
        pairs=pairs,
        timeframe='1h',  # Changed to 1h for more trades
        period_days=720,
        rsi_period=14,
        stoch_period=14,
        k_period=3,
    ...
    print("\n✅ Optimized multi-pair Stochastic RSI backtest complete!")